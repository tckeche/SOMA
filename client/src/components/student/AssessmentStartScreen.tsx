    ...
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass-card p-6 md:p-10 text-center">
          ...
          <p className="text-xs uppercase tracking-[0.2em] text-slate-500 mb-2">Ready to begin?</p>
          <h1
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 mb-6 divide-y divide-white/5">
            {rows.map((row) => {
              const Icon = row.icon;
              return (
                <div
          ...
          <div className="text-left bg-white/[0.02] border border-white/5 rounded-xl p-4 md:p-5 mb-6 space-y-2.5">
            <p className="text-xs uppercase tracking-wider text-slate-500 mb-1">What to expect</p>
