  ...
  if (isLoading) {
    return (
      <button
        type="button"
        disabled
        className="inline-flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg border border-warning/30 bg-warning/5 text-warning opacity-60 min-h-[40px]"
    ...
    <div className="relative inline-block">
      <button
        ...
        className={`inline-flex items-center gap-1.5 text-xs px-3 py-2 min-h-[40px] rounded-lg border transition-colors font-medium ${
          isFlagged
            ? "bg-warning/15 border-warning/50 text-warning hover:bg-warning/25"
            : "bg-warning/5 border-warning/30 text-warning hover:bg-warning/15 hover:border-warning/50"
        }`}
      ...
      {open && !isFlagged && (
        <div
          className="absolute right-0 top-full mt-2 w-72 rounded-xl border border-warning/30 bg-card p-3 shadow-2xl z-30"
          data-testid="flag-popover"
        >
          <p className="text-xs font-semibold text-warning mb-1">Flag this question</p>
          ...
          <textarea
            ...
            className="w-full rounded-lg bg-background/60 border border-border text-xs text-foreground px-2 py-1.5 focus:outline-none focus:border-warning/40"
          ...
          <div className="flex items-center justify-end gap-2 mt-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-[11px] font-medium text-warning bg-warning/20 border border-warning/40 px-2.5 py-1 rounded hover:bg-warning/30 disabled:opacity-60"
