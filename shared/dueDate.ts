...
//
// When a tutor assigns an assessment, the due date defaults to 5 days after the
// assessment was created, floored to the start of that hour. For example, an
// assessment created at 15:23 defaults to a due date 5 days later at 15:00. The
// tutor can always move the date earlier or later before assigning.

export const DEFAULT_DUE_DAYS = 5;

// Compute the default due date: createdAt + 5 days, with minutes/seconds/ms
